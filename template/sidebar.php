      ...
      <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu" aria-labelledby="sidebarMenuLabel">
        ...
        <div class="offcanvas-body d-md-flex flex-column p-0 pt-lg-3 overflow-y-auto">
          <ul class="nav flex-column">
            ...
            ?>
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 <?= $menu == 'daftarpoli' ? 'active' : null ?>" href="<?= $main_url ?>daftarpoli">
            ...
            <?php } ?>
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2  <?= $menu == 'auth' ? 'active' : null ?>" href="<?= $main_url ?>auth/password.php">
          ...
          <ul class="nav flex-column mb-auto">
            ...
            <?php } ?>
            <li class="nav-item">
              <a class="nav-link d-flex align-items-center gap-2 <?= $menu == 'poli' ? 'active' : null ?>" href="<?= $main_url ?>poli">
