      ...
      <div class="row">
        ...
        <div class="col-lg-8">
            <div class="form-group mb-3">
                ...
                <input type="text" name="username" class="form-control" id="username" placeholder="masukkan username" autocomplete="off" autofokus required>
            </div>
            <div class="form-group mb-3">
            ...
            <div class="form-group mb-3">
                ...
                <textarea name="alamat" id="alamat" cols="" rows="3" class="form-control" placeholder="masukkan alamat"></textarea>
            </div>
        </div>
      </div>
      </form>
