...
?>
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 min-vh-100">
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <a href="<?= $main_url ?>user" class="text-decoration-none"><i class="bi bi-arrow-left"></i> Kembali</a>
      </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-8">
            ...
            <input type="hidden" name="usernameLama" value="<?=$user['username'] ?>">
                ...
                <input type="text" name="username" class="form-control" id="username" placeholder="masukkan username" value="<?= isset($user['username']) ? $user['username'] : '' ?>" autocomplete="off" autofokus required>
            </div>
            <div class="form-group mb-3">
                <label for="fullname" class="form-label">Fullname</label>
                <input type="text" name="fullname" class="form-control" id="fullname" value="<?= isset($user['fullname']) ? $user['fullname'] : '' ?>" placeholder="masukkan nama lengkap" required>
            </div>
            <div class="form-group mb-3">
                <label for="jabatan" class="form-label">Jabatan</label>
                <select name="jabatan" id="jabatan" class="form-select" required>
                    <option value="">-- Pilih Jabatan --</option>
                    <option value="1" <?= isset($user['jabatan']) == 1 ? 'selected' : '' ?>>Admin</option>
                    <option value="2" <?= isset($user['jabatan']) == 2 ? 'selected' : '' ?>>Pasien</option>
                    <option value="3" <?= isset($user['jabatan']) == 3 ? 'selected' : '' ?>>Dokter</option>
                </select>
            </div>
            <div class="form-group mb-3">
                <label for="alamat" class="form-label">Alamat</label>
                <textarea name="alamat" id="alamat" cols="" rows="3" class="form-control" placeholder="masukkan alamat"><?= isset($user['alamat']) ? $user['alamat'] : '' ?></textarea>
            </div>
        </div>
      </div>
      </form>
