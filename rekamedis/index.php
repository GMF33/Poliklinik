...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 min-vh-100">
    ...
    <table class="table table-responsive table-hover" id="myTable">
        ...
        <tbody>
            <?php
            $no = 1;
            $sqlrm = "SELECT *, pasien.alamat AS alamatpasien FROM rekamedis INNER JOIN pasien ON rekamedis.id_pasien = pasien.id INNER JOIN user ON rekamedis.id_dokter = user.id order by tgl_rm desc";
            ...
            ?>
                <tr>
                    ...
                    <td>
                        ...
                        <a href="proses-data.php?id=<?= $rm['no_rm'] ?>&aksi=hapus-data" onclick="return confirm('Anda yakin ingin menghapus ?')" class="btn btn-sm btn-outline-danger" title="hapus data"><i class="bi bi-trash align-top"></i></a>
                    </td>
                </tr>
            <?php } ?>
        </tbody>
