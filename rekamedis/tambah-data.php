...
$today   = date('dmy');
$queryNo = mysqli_query($koneksi, "SELECT max(no_rm) as maxno FROM rekamedis WHERE right(no_rm, 6) = '$today'");
      ...
      <div class="row">
        ...
        <div class="col-lg-6 pe-4">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" id="noktp" class="form-control border-0 border-bottom mb-3" placeholder="no ktp" readonly>
                <input type="text" id="nohp" class="form-control border-0 border-bottom mb-3" placeholder="no hp" readonly>
                <input type="text" id="norm" class="form-control border-0 border-bottom mb-3" placeholder="no rm" readonly>
            </div>   
        </div>
